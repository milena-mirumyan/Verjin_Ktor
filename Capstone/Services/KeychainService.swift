...
open class KeychainService {
  ...
  private static let defaultServiceName: String = {
    Bundle.main.bundleIdentifier ?? "SwiftKeychainService"
  }()
  
  /// Initializers
  
  /// Create an instance of `KeychainService` with a custom service name and optional access group.
  ///
...
public struct KeychainStoreString {
  ...
  public var wrappedValue: String? {
    get {
      KeychainService.default.string(forKey: key)
    }
    
    set {
      guard let v = newValue else { return }
      
      KeychainService.default.set(v, forKey: key)
    }
  }
  
  public var projectedValue: KeychainService {
    get {
      return KeychainService.default
    }
  }
}
